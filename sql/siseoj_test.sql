...
CREATE TABLE `sys_roles_menus`  (
                                    `menu_id` bigint(0) NOT NULL COMMENT '菜单外键',
                                    `role_id` bigint(0) NOT NULL COMMENT '角色外键',
...
CREATE TABLE `sys_users_roles`  (
                                    `user_id` bigint(0) NOT NULL COMMENT '用户信息表主键',
                                    `role_id` bigint(0) NOT NULL COMMENT '角色表主键',
